from sdlc_ai_project.utils import load_agents
from sdlc_ai_project.llms import deepseek_llm, gemini_llm

def main():

    output = load_agents(user_requirements="Build a todo app with user authentication",project_context="A simple web application for task management", llm=gemini_llm)
    print(output)
    pass
